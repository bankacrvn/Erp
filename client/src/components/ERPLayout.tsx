      ...
      >
          ...
          <nav className="space-y-1 px-2">
            {uniqueMenuItems.map((item) => (
              <Button
                ...
                } h-12 text-gray-700 dark:text-gray-300 hover:bg-purple-50 dark:hover:bg-purple-900/20 hover:text-purple-600 dark:hover:text-purple-400`}
        ...
        <div className="p-4 border-t border-gray-200 dark:border-gray-700 space-y-2">
          ...
          <Button
            ...
            className={`w-full ${
              collapsed ? 'justify-center px-2' : 'justify-start px-4'
            } h-12 text-red-600 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-900/20`}
